...
class DataHandlerSequential:
    def __init__(self):
        if configs['data']['name'] == 'ml-20m':
            ...
            predir = './datasets/sequential/last-fm_seq/'
        elif configs['data']['name'] == 'amazon-book':
            predir = './datasets/sequential/amazon-book_seq/'
        elif configs['data']['name'] == 'Amazon_Books':
            predir = './datasets/sequential/Amazon_Books_seq/'
        elif configs['data']['name'] in [
            'ml-100k', 'ml-1m', 'ml-10m', 'ml-20m', 'Amazon_Books', 
            'lfm1b-albums', 'lfm1b-artists', 'lfm1b-tracks'
        ]:
            predir = f'./datasets/sequential/{configs["data"]["name"]}_seq/'
        else:

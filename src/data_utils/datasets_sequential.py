...
class SequentialDataset(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        elif configs['model']['name'] in ['ksr', 'fdsa']:
            seq, seq_len = self._pad_seq_reverse(seq_i)
            return self.uids[idx], torch.LongTensor(seq), seq_len, self.last_items[idx]
        else:
